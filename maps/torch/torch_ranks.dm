...
//This variable, contrary to apperances, is not currently public-facing, but it's embedded into outfit preview code, specifically, far more throughoughly than I know how to dig out.
/datum/mil_rank/grade()
	. = ..()
	if(!sort_order)
		return ""
	if(sort_order <= 100)
		return "Enlisted-[sort_order]"
	return "Officer-[sort_order - 100]"
